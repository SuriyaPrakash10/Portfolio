...
const Experience = () => {
  ...
  return (
    <div
      id="experience"
      name="Experience"
      className="bg-gradient-to-b from-gray-800 to-black text-white w-full min-h-screen pt-44"
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div>
          <p className="text-4xl font-bold p-2 inline-block border-b-4 border-gray-500">
            Experience
          </p>
